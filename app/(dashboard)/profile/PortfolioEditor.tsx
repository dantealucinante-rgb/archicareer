...
export default function PortfolioEditor({ initialItems, variant = "individual", startCollapsed = false }: Props) {
    ...
    return <section id="portfolio" className="scroll-mt-28">
        ...
        {composerOpen && <form onSubmit={handleSubmit} className="surface mt-6 space-y-5 rounded-2xl p-5 sm:p-7"><p className="eyebrow font-mono text-redline">{editingId ? "EDIT PROJECT" : "ADD A PROJECT"}</p>
