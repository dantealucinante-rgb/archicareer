-- Harden the already-deployed rate-limit function. The caller-supplied
-- p_limit parameter is intentionally ignored; limits are server-controlled.
...
-- Do not expose account identifiers or notification preferences to anonymous
-- clients through Supabase's direct table API.
